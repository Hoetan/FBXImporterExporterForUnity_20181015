	...
	void RotateJointUpdate(int bone)
	{
		if (_bones[bone] != null) {
			if(bone == (int)Kinect.NuiSkeletonPositionIndex.Spine)
			{
                ...
                {
                    vecPos = Vector3.Slerp(_vecbones2[bone], _vecbones[bone], fLerpPosition * (fLerpDeltaTime * iFPS));
                }
            ...
            {
                quat = Quaternion.Slerp(_qbones2[bone], _qbones[bone], fLerpRotation * (fLerpDeltaTime * iFPS));
            }
