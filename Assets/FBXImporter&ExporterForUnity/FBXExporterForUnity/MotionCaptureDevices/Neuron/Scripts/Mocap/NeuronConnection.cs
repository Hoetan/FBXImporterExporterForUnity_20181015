...
namespace Neuron
{
	public static class NeuronConnection
	{
        ...
        public static NeuronSource CreateConnection( string address, int port, int commandServerPort, SocketType socketType )
		{	
		...
		public static void DestroyConnection( NeuronSource source )
		{
			if( source != null )
			{
